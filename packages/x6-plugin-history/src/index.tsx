  ...
  implements IDisablable
{
  ...
  protected redoStack: CombinedStackItem[]

  protected undoStack: CombinedStackItem[]
  ...
  addUndo(undoStack: CombinedStackItem[]) {
...
export namespace History {
  ...
  export type Options = Partial<CommonOptions>
