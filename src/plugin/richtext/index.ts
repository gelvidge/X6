import { Basecoat, CssLoader, disposable, Dom } from '../../common'
import type { Graph, GraphPlugin } from '../../graph'
import type { Node } from '../../model'
import type { LexicalEditor } from 'lexical'
import { FORMAT_ON_COMMAND, NodeEditor } from './NodeEditor'
import { content } from './style/raw'
import './api'

export { FORMAT_ON_COMMAND }

export class Richtext extends Basecoat implements GraphPlugin {
